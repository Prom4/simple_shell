...
/**
 * _memcpy - copying information between void pointers.
 * @newptr: destinations pointer.
 * @ptr: sources pointers.
...
/**
 * _reallocdp - reallocate a memory blocks of double pointers.
